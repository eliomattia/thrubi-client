...
const _GlobalStats = ({
    ...
    <span className="text-primary text-center small mr-2">
        A {nUser}-strong community for sustainable worldwide income redistribution.
        Launching in {nCountry} {nCountry===1?"country":"countries"} and {nCcy} {nCcy===1?"currency":"currencies"}.
    </span>
);
